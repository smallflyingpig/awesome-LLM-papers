...
2025\newline 2026 & LongCat\cite{longcatflash,longcat2} & MoE & Flash 560B; 2.0 1.6T & Flash 18.6--31.3B（均值约 27B）; 2.0 约 48B & Flash 未公开; 2.0 超过 35T & C$+$ & 同家族 total/active/data 同时扩展；跨代架构变化，不能归因于单轴。 \\
2025\newline 2026 & Kimi K2/K3\cite{kimik2,kimik3} & MoE 多模态 & K2 1T; K3 2.8T & 32B; 104B & K2 15.5T; K3 未公开 & C$+$ & 展示更高 sparsity 下容量与 active compute 联合扩展；K3 非 fit-ready。 \\
2025\newline 2026 & GLM 4.5/5\cite{glm5} & MoE & 355B; 744B & 32B; 40B & 23T; 28.5T & B$-$ & 同家族公开纵向点；参数、数据、架构及 post-training 同时变化。 \\
...
2026 & Claude Fable 5\cite{claudefable5} & 未公开 & 未公开 & 未公开 & 未公开 & C & 官方确认产品与 system card，但训练尺度未披露；只能作为披露边界，不能拟合 scaling。 \\
\end{longtable}
