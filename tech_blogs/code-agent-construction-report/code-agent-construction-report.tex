...
\end{center}
\vspace{5pt}
{\footnotesize\setstretch{0.98}\setlength{\parskip}{0pt}\tableofcontents}
...
\draw[arr] (pre) -- (mid);
\draw[arr] (mid) -- (post);
\draw[arr,rounded corners=1.5pt] (post.south west) -- ++(0,-4mm) |- (agent.north east);
\draw[arr] (env) -- (agent);
\draw[arr] (agent) -- (eval);
\draw[arr] (eval.north east) -- (post.south east);
